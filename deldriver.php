...
?>
    ...
    <body style="background-image: linear-gradient(135deg,#636363,#2dc9c9,#ffd452, #9643b9 );">
        <?php
        $z = $conn->prepare("SELECT * from driver");
        $z->execute();
        ?>
        <div class="header">
                ...
                <div class="container">
                    <div class="row text-pink">
                        <div class="col-xl-5 col-lg-6 col-md-8 col-sm-10 mx-auto text-center form p-4">
                            <div>
                                <hr>
                                <h1 style="color: #000000;"><b>DELETE DRIVER</b></h1>
                            </div>
                            <div class="px-2">
                                ...
                                if (isset($_POST['del'])) {
                                    ...
                                    $stmt->execute();
                                    $d = "DELETE FROM driver where did= $did";
                                    $conn->exec($d);
                                ?>
                                    <table align="center" style='border: solid 1px black;'>
                                        ...
                                        <hr><br> <?php
                                            ...
                                            <tr>
                                                ...
                                                <td align="center"><?php echo $row['dnum']; ?></td>
                                                <td align="center"><?php echo $row['dage']; ?></td>
                                            </tr>
                                    <?php }
                                                } ?>
                            </div>
